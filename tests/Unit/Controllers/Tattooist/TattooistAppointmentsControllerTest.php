...
class TattooistAppointmentsControllerTest extends ControllerTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->user->save();
        $_SESSION['user']['id'] = $this->tattooist->id;
    }
    ...
    public function test_list_all_appointments(): void
    {
        ...
        $response = $this->get(action: 'index', controllerName: 'App\Controllers\Tattooists\AppointmentsController');

        foreach ($appointments as $appointment) {
            $this->assertMatchesRegularExpression("/{$appointment->user->name}/", $response);
        }
    }
    ...
    public function test_show_appointment(): void
    {
        ...
        $response = $this->get(
            action: 'show',
            controllerName: 'App\Controllers\Tattooists\AppointmentsController',
    ...
    public function test_successfully_create_appointment(): void
    {
        ...
        $this->assertMatchesRegularExpression("/Location: \/tattooist\/appointments/", $response);
    }
