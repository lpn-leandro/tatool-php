...
class UserTest extends TestCase
{
    ...
    public function test_should_get_user_type(): void
    {
        $this->assertEquals('U', $this->user->user_type);
        $this->assertEquals('T', $this->tattooist->user_type);
    }
}
